...
#ifndef __CONFIG_SOCFPGA_FLUKE_CDA_VANQUISH_H__
#define __CONFIG_SOCFPGA_FLUKE_CDA_VANQUISH_H__
...
/*
#define CONFIG_SYS_PROMPT		"Fluke Vanquish A9 Rev002 # " 
*/
...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "qspiboot=setenv bootargs " CONFIG_BOOTARGS \
                " ${qspirootpartition} root=${qspiroot} rw rootfstype=${qspirootfstype} vt.global_cursor_default=0 coherent_pool=256K mem=${mem} isolcpus=1; "\
                "bootz ${loadaddr} - ${fdtaddr}\0" \
        "fpga=0\0" \
...
#endif  /* __CONFIG_SOCFPGA_FLUKE_CDA_VANQUISH_H__ */
